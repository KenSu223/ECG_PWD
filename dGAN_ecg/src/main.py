...
class CustomCallback(keras.callbacks.Callback):
    def on_epoch_end(self, epoch, logs=None):
        ...
        np.save('./DCGAN_beat/logs/discriminator_losses.npy', d_losses)
        np.save('./DCGAN_beat/logs/generator_losses.npy', g_losses)
        np.save('./DCGAN_beat/logs/discriminator_accuracies.npy', d_accuracies)
        np.save('./DCGAN_beat/logs/generator_accuracies.npy', g_accuracies)

    def on_train_end(self, logs=None):
        # Save the final generator and discriminator models
        self.model.generator.save('./DCGAN_beat/models/final_generator_4.h5')
        self.model.discriminator.save('./DCGAN_beat/models/final_discriminator_4.h5')
...
plt.legend()
plt.savefig('DCGAN_beat/plots/loss-acc.png')
plt.show()
...
generated_dopplers = dcgan.generator.predict(selected_ecgs).reshape(4,800)
