"""Configurable single-channel training pipeline for patient-aware train/validation splits. Supports learning-rate schedules, checkpointing, and run-summary export."""
