"""Configurable two-channel training script (MAE objective) with patient-level leakage checks, checkpoints, and training-log export."""

# train_fusion_wavenet.py
import os
import numpy as np
...
def main(
    ...
    risk_groups_file="RISK_GROUPS.npy",  # ADD: Optional, for logging purposes
