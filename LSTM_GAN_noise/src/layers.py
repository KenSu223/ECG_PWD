...
def LSTM(units, return_sequences = False):
    layer = keras.layers.LSTM(units=units, activation="tanh", recurrent_activation="sigmoid",
    ...
    bias_constraint=None, dropout=0.0, recurrent_dropout=0.0, seed=None, return_sequences=return_sequences,
